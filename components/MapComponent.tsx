...
export default function MapComponent({canchas}: MapComponentProps) {
    // Estado para evitar el doble render
    ...
    // Si todavía no está montado, no renderizamos el mapa
    if (!mounted) return <div className="w-full h-96 rounded-lg bg-gray-100"/>;
